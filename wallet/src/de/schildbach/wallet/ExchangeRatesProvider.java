...
public class ExchangeRatesProvider extends ContentProvider
{
	...
	public Cursor query(final Uri uri, final String[] projection, final String selection, final String[] selectionArgs, final String sortOrder)
	{
		...
		if (!offline && (lastUpdated == 0 || now - lastUpdated > UPDATE_FREQ_MS) || forceRefresh)
		{
			...
			if ((dogeBtcConversion == -1) || forceRefresh)
			...
			if (newExchangeRates != null)
			{
				...
				newExchangeRates.put("mBTC", new ExchangeRate(new org.bitcoinj.utils.ExchangeRate(Fiat.parseFiat("mBTC", strmBTCRate)), providerUrl));
						...
						for (final String field : fields)
						{
							...
							if (rate != null)
							{
								try
								{
									...
									{
										rates.put(currencyCode, new ExchangeRate(new org.bitcoinj.utils.ExchangeRate(dogeRate), source));
										break;
									}
								}
